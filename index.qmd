...
- **[Momentum, Adaptive Methods, and SGD](lectures/07-momentum-adaptive-sgd.qmd)** --- Beyond vanilla gradient descent: momentum methods, Nesterov's accelerated gradient, adaptive methods (AdaGrad, RMSProp, Adam), stochastic gradient descent, and proximal gradient methods for composite objectives.
...
- **[Newton's Method and Matrix Optimizers](lectures/14-newton-method.qmd)** --- Exploiting curvature: Newton's method achieves quadratic convergence via the Hessian, and modern matrix optimizers (Muon, Shampoo, SOAP) extend preconditioning to neural network weight geometry.
